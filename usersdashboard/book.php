    ...
    <?php include ("headerMenu.php"); ?>
        ...
        <!-- check if the user booked a ride  -->
                ...
                <?php
                        ...
                        $query = "SELECT * FROM ridebooking WHERE id = :id ORDER BY created_at DESC";
                        ...
                        try {
                            ...
                            $stmt = $db->query($query);
                                ...
                                // Bind the user_id parameter
                                    $stmt->bindParam(':id', $user_id, PDO::PARAM_INT); // Replace $user_id with the actual user ID value
